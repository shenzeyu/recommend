...
<script language="JavaScript" type="text/javascript" src="${ctx}/scripts/js/jquery.form.js"></script>
...
<!--   <h2><img src="${ctx}/Images/images/y30.jpg" /></h2>-->
	...
	<img src="${ctx }/verifyKey/verifyKey.jpg" id="Image"  style="cursor:hand;" alt="看不清，换一张"/></div></h2>
  ...
  <div class="login0202_text2">
   <div class="login0202_text201"><input style="cursor:text" id="agreeRegister" name="" type="button"  class="login0202_text1btn" value="同意协议并注册" onclick="submitRegisterForm()"/></div>
  <div class="login0202_text202">
  <h3><span><input name="" type="checkbox" value="" id="read"/></span><samp>我已经阅读并同意</samp></h3>
  <h2><a href="javascript:void(0)" onclick="chgb()">《上理在线学院用户协议书》</a></h2>
  </div>
  </div>
  <div id="szd" class="Agreement" style="display:none;">
  <div class="Agreement01">
  <span> 上理在线学院用户注册协议</span>
  本协议是您与上理在线学院所有者之间就上理在线学院服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击“同意以下协议，提交”按钮后，本协议即构成对双方有约束力的法律文件。<br />
  第1条 本站服务条款的确认和接纳<br />
  1.1本站的各项电子服务的所有权和运作权归上理在线学院所有。用户同意所有注册协议条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的契约，始终有效，法律另有强制性规定或双方另有特别约定的，依其规定。<br />
