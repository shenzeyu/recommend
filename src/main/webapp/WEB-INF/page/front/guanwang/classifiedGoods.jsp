...
<div class="ad" >  
  	<ul class="slider" >
       ...
       <div class="newArr_text"><span class="newArr_textys">新品上架</span></div>
       <div class="newArr_text1" >
          <ul>
          	<c:forEach items="${goodList1}" var="good" begin="0" end="7">
	            <li><a href="${ctx }/cpxq.do?good.id=${good.id }"><img src="${ctx}${good.pic }" width="162"  height="162"/></a>
        ...
        <!--[if !IE]>今日推荐<![endif]-->
        <div class="newArrivals">
       <div class="newArr_text"><span class="newArr_textys">今日推荐</span></div>
       <div class="newArr_text1" >
          <ul>
          	<c:forEach items="${goodList3}" var="good" begin="0" end="7">
	            <li><a href="${ctx }/cpxq.do?good.id=${good.id }"><img src="${ctx}${good.pic }" width="162"  height="162"/></a>
	              <p><a href="${ctx }/cpxq.do?good.id=${good.id }">${good.name }<samp>${good.introBrief }</samp></a></p>
	              <span>¥${good.price }</span>
	            </li>
