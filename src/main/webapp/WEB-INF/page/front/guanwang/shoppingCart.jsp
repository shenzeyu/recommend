...
<!--[if !IE]>头部<![endif]-->
  <div class="ctop">
	    <div class="top_con">
		      ...
		      <div class="top_ctext2"><span class="ys1"><a href="${ctx }/customersManage.do" target="_parent">我的在线学院</a> |</span>
  ...
  <c:forEach items="${shoppingCar.goodsInCarList}" var="goodsIncar" varStatus="i">
   ...
   <div class="shopcart2_text102">
   <h1>返      现：</h1>
   <h2><span class="font">¥</span>0.00</h2>
   </div>
   </div>
   <div class="shopcart3">
