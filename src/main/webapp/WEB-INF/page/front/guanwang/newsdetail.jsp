...
<!--<iframe width="100%" height=191 frameborder=0 scrolling=no src="header.htm" style="z-index:1000"></iframe> -->
  ...
  <div class="article2">文章来源：<a href="#">e购网</a> <span>发表时间：<fmt:formatDate  pattern=" yyyy-MM-dd hh:mm:ss" value="${information.createTime }"/></span> </div>
  <div class="article3">
  	${information.content }
  </div>
   <!--[if !IE]>单页内容结束<![endif]-->
...
<!--	   </div>-->
  ...
  <div class="newsshow_right">
  	<div class="newsright_text"><a href="newsdetail.html"><img src="${ctx }/Images/images/lay11.jpg" border="0" /></a></div>
<!--  		-->
