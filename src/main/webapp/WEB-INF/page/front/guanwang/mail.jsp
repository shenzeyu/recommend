...
<script type="text/javascript" src="${ctx }/scripts/front/clients_js/pwd.js"></script>
<script>
...
<li id="bor"><a href="${ctx }/myaddress.do" >地址管理</a></li>
      ...
      <div class="coupon_right">
        <div class="courht">
          ...
          <div class="modify1">
            <div class="modify1_content">
              <div class="modify101">
                <h1><span>*</span>我的邮箱地址：</h1>
                <h2>${customer.email }</h2>
              </div>
              <div class="modify103">
                <h1><span>*</span>新邮箱地址</h1>
                <h2>
                  <input name="" id="newEmail" type="text"  class="pickinput1" onchange="checkEmail(this.value)"/>
                </h2>
              </div>
              <div class="modify101">
                <h1><span>*</span>验证码：</h1>
                <h2>
                  <input name="" type="text"  class="pickinput"/>
                </h2>
                <h5><img src="${ctx}/Images/images/pass3.jpg" /></h5>
                <h5>看不清楚，</h5>
                <h4><a href="#">换一张</a></h4>
              </div>
              <div class="modify102">
                <input name="" type="button"  class="forgotpasswordbutton" onclick="updateEmail()"/>
              </div>
            </div>
          </div>
        </div>
