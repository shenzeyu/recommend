...
<body>
<div class="box">
<s:hidden name="wareComment.code" id="wareCommentCode"/>
<s:hidden name="wareComment.wareId" id="wareCommentWareId"/>
...
<div class="photocomment4"><input name="" type="button" class="photocommentbtn" onclick="submitSaveCommentTwo()"/></div>
<!--[if !IE]>产品评价<![endif]-->
</div>
</div>
</form>
