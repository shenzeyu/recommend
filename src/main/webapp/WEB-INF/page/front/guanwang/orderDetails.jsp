...
<div class="content">
<div class="coupon">
<div  class="orderDetails"><samp><a href="${ctx }/customersManage.do">我的在线学院</a></samp><span>></span><span class="ordys"><a href="${ctx }/paymentOrder.do">未付款订单</a></span><span>></span><span id="ordysn1">订单详情</span></div>
<!--[if !IE]>订单详情<![endif]-->
...
<h4>
	<c:if test="${saleOrder.paymentState!='2' && saleOrder.iscancel=='0'}">
		<!-- <input name="" type="button"  class="orderDetails201btn" value="支付"/> -->
		<a href="#" onclick="odpy('ordpaly','fade')"><input name="" value="支付" type="button" class="orderDetails201btn" onclick="bankPay('${saleOrder.id}','${saleOrder.bankCode}')"/></a>
	</c:if>
...
<li id="orderys">发票信息</li>
<li>发票类型：<c:if test="${saleOrder.invoiceType=='0'}">普通发票</c:if><c:if test="${saleOrder.invoiceType=='1'}">增值税发票</c:if></li>
<li>发票抬头：${saleOrder.invoicePayable }</li>
<li>发票内容：${saleOrder.invoiceContent }</li>
</ul>
</div>
<div class="orderDetails4">
<span>商品清单</span>
