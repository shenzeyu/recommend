...
<div class="cartproductfluctuate" id="cart_container" style="display: none;">
  <div class="shoppingCart1">
    ...
    <div class="shoppingCart1_text1">
      ...
      <h2><a href="${ctx }/jiesuan.dojavascript:jiesuan();">去结算</a></h2>
    </div>
  </div>
</div>
<div class="cartfluctuate" id="show_cart" style="display: block;">
  <div class="shoppingCart" id="shoppingCarSize">
    <h1>已添加<span id="shoppingCarSize">(<c:if test="${shoppingCarSize==null}">0</c:if>${shoppingCarSize })</span>件</h1>
  </div>
</div>
</body>
</html>
