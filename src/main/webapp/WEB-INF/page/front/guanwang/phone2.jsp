...
<link href="style/phone2_page.css" rel="stylesheet" type="text/css" />
...
<div class="couponleft_title"><a href="myshop.html">我的在线学院</a></div>
<!--[if !IE]>订单中心<![endif]-->
...
<!--[if !IE]>end<![endif]-->
	...
	您可以<span><a href="login.html">立即登录</a></span>，或返回<span><a href="index.html">官网首页</a></span>
	</div>
	</div>
		   </div>
        </div>
