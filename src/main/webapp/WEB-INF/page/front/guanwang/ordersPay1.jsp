...
<div class="box">
  ...
  <div class="ctop">
    <div class="top_con">
      <div class="top_ctext">您好，欢迎您！<span id="top_ctextys">${loginCustomer.code }</span></div>
      <div class="top_ctext1">
        <input name="" type="button" class="subbmit" value="退出" />
      </div>
      <div class="top_ctext2"><span class="ys1"><a href="myshop.html" target="_parent">我的在线学院</a> |</span><span class="ys2"><img src="${ctx }/Images/images/a1.jpg" /></span><span class="ys3"><a href="shoppingCart.html" target="_parent">购物车0件</a> | <a href="#">售后服务</a></span></div>
    </div>
  ...
  <div class="Payment02">
          <ul>
            <li>
              <h1>
                <input name="bank_code" type="radio" value="ZFB" checked="checked" />
              </h1>
              <h2><img src="${ctx }/Images/bank/ZFB.jpg" /></h2>
            </li>
            </ul>
        </div>
        <input id="bCode" type="hidden" value="ZFB"/>
  </div>
