...
<div  class="orderDetails">
	<samp>
		<c:if test="${loginCustomer!=null }"><a href="${ctx }/customersManage.do">我的在线学院</a></c:if>
		<c:if test="${loginCustomer==null }"><a href="javascript:void(0);" onclick="myshops('1')">我的在线学院</a></c:if><!-- ShowDiv('MyDiv','fade') -->
	</samp>
	<span>></span>
	<span class="ordys">
		<c:if test="${loginCustomer!=null }"><a href="${ctx }/customersManage.do">待评价资料</a></c:if>
		<c:if test="${loginCustomer==null }"><a href="javascript:void(0);" onclick="myshops('2')">待评价资料</a></c:if>
	</span>
	<span>></span>
...
<div id="remakeDIV">
	...
	<samp>填写您对此资料的使用心得，例如该资料或某功能为您带来的帮助，或使用过程中遇到的问题等，最多可输入200字。</samp>
</div>
</h2>
</div>
