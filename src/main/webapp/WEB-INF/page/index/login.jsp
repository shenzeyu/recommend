...
<div class="whole">
	...
	<div class="middle">
		...
		<tr>
			<td>
	    		<div class="left"><img src="${ctx}/imgs/picture.jpg" width="478" height="380" /></div>
	    	</td>
	    	<td>
	        	<div class="line"></div>
	        </td>
        ...
        <div class="right">
        	<div class="login">
	        	<form action="${ctx }/SysLogin!login.do" name="loginForm" id="loginForm" method="post" onsubmit="return checkForm();">
		          ...
		          <div class="loginfont">登陆&nbsp;上理在线学院后台系统</div>
			      <table align="left" width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height:2.5em;">
		            <tr>
		              ...
		              <td><input name="sysUser.code" type="text" class="text" id="UserName" style="width:120px;height: 1.45em;" />&nbsp;&nbsp;<span id="showmsgUserA"></span></td>
		            </tr>
		            <tr>
    ...
    <div class="foot">
    	<div class="footfont"><a href="http://www.usst.edu.cn"><span style="font-size: 12">上海理工大学</span></a><span> Copyright @ 2016</span></div>
