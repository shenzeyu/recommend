...
<head>
	...
	<script type="text/javascript" src="${ctx }/scripts/good/goodType/edit_goodType.js"></script>
</head> 
...
<body>
	...
	<div style="margin-top: 10px; margin-bottom: 5px;">
		<table border="0" cellpadding="0"  cellspacing="1" class="gdcn-table-bgcolor" width="100%" style="font-size: 12px;">
			<tr>
				...
				<td class='gridbody'><input type="text" id="goodCode" onkeydown="checkKey()" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" /></td>
				<td class='gridtitle'>类别名称：</td>
				<td class='gridbody'><input type="text" id="goodName" onkeydown="checkKey()" onkeyup="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\u4E00-\u9FA5]/g,''))"></td>
				<td class='gridtitle'>
	...
	<div id="edit" closed="true">
		<iframe frameborder="0" id="editDataPage" width="950px" height="350px"></iframe>
	</div>
