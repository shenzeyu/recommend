...
<head>
	...
	<script type="text/javascript" src="${ctx }/scripts/good/goodSpecification/list_goodSpecification.js"></script>
...
<body>
	...
	<div id="list" closed="true">
		<iframe frameborder="0" id="listDataPage" width="850px" height="500px"></iframe>
	</div>
</body>
