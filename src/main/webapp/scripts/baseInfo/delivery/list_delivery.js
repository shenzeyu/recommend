...
$(document).ready(function(){ 
	//列表
	$(gId).datagrid({
		url:ctx+'/Delivery_json!listJson.do',
		idField:'id',
		fitColumns:true,
		frozenColumns:[[
		...
		columns:[
			...
			[
				...
				{field:'name',title:'配送方式',width:130,align:'left'},
				{field:'deliveryFee',title:'配送费用',width:80,align:'left'}
