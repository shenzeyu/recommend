	...
	$(gId).datagrid({
		...
		columns:[
			...
			[
				...
				{field:'areaIds',title:'',width:0,align:'left'},
...
//Json加载数据路径
function getUrlOpt(){
	var url = ctx+'/Customer_json!listJson.do?1=1';
	var vipLevelId = $("#vipLevelId").val();
	if(vipLevelId != ''){
		url += '&customer.vipLevelId='+vipLevelId;
	}
	return url;
}
