					...
					try{
						...
						for(j=0;j<order.warelist.length;j++){
						    ...
						    if(order.orderState=='0'){
								htmlText+="待审核";
							}else if(order.orderState=='1' && order.paymentState=='2' && (order.deliveryState=='1'||order.deliveryState=='2')){
								htmlText+="已完成";
							}else if((order.deliveryState=='1'&&order.orderState=='1')){
								htmlText+="已发货";
							}else if((order.paymentState=='0' || order.paymentState=='1')&&order.orderState=='1'&&order.deliveryState=='0'){
								htmlText+="待付款";
							}else if(order.deliveryState=='0'){
								htmlText+="未发货";
