	...
	$.ajax({
			...
			success : function(returnData){  
				...
				for(i=0;i<rows.length;i++){
                    ...
                    htmlText+="<div class='wantedList02'><a href=javascript:addGoodToCart('"+good.id+"') id='1154"+i+"' class='listcart'>加入购物车</a><span><a href='javascript:void(0);' onclick=addGoodToFavorite('"+good.id+"')>收藏</a></span></div></div>";
				}
