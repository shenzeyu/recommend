package com.usst.app.vip.prepaid.action;
	...
	public void save() {
		...
		try {
			...
			if ("s".equals(this.prepaid.getState())) {
				try {
					this.customerService.updatePayables(this.prepaid.getCustomerId(),
							Double.valueOf(0.0D + this.prepaid.getPrepaidMoney().doubleValue()));
				} catch (Exception e) {
