package com.usst.app.component.file.service;
...
public class FileUploadService extends BaseService<FileUpload> {
	...
	public void updateAppId(String id, String appId) throws Exception {
	...
	public void removeAppId(String picPathArr, String appId) throws Exception {
	...
	public void cleanAppId(String appId) throws Exception {
	...
	public List<FileUpload> getFileUploadByGoodId(String goodId) throws Exception {
		...
		List<FileUpload> list = this.publicDAO.select("FileUpload.FileUpload", map);
		return list;
	}

	public List<FileUpload> getFileUploadById(String id) throws Exception {
		if (StringUtils.isBlank(id)) {
			throw new Exception("the  key goodId is empty");
		}
		Map map = new HashMap();
