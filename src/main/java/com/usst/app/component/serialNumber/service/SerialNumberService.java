package com.usst.app.component.serialNumber.service;
...
import com.usst.app.component.serialNumber.model.SerialNumber;
import com.usst.code.service.BaseService;
import com.usst.code.util.DateUtil;
import com.usst.code.util.NumberUtil;
@Service
public class SerialNumberService extends BaseService<SerialNumber> {
	...
	public String getSerialNumberNoDate(String prefix, String appType, int bit) throws Exception {
		if (StringUtils.isBlank(appType)) {
			logger.error("appType is empty");
			throw new Exception("appType is empty");
		}
