package com.usst.app.warehouse.warehousePosition.action;
...
import com.usst.app.warehouse.warehousePosition.service.WarehousePositionService;
...
public class WarehousePositionAction extends BaseAction {
	...
	public String listJson() {
		...
		List<WarehousePosition> resultList = null;
		int totalRows = 0;
		try {
	...
	public String edit() {
		...
		if (StringUtils.isNotBlank(this.warehousePosition.getId())) {
			this.warehousePosition = ((WarehousePosition) this.warehousePositionService
					.getModel(this.warehousePosition.getId()));
