...
public class WarehousePositionWareService extends BaseService<WarehousePositionWare> {
	public List<WarehousePositionWare> getWareByPositionId(String positionId) throws Exception {
		if (StringUtils.isBlank(positionId)) {
			throw new Exception("intoId is null");
		}
		Map<String, String> param = new HashMap();
		param.put("warehousePositionId", positionId);
		List<WarehousePositionWare> resultList = this.publicDAO.select("WarehousePositionWare.WarehousePositionWare",
				param);
		return resultList;
	}

	public void updateWareNum(Map<String, String> param, int changeNum) throws Exception {
		...
		WarehousePositionWare warehousePositionWare = (WarehousePositionWare) this.publicDAO
				.selectOne("WarehousePositionWare.WarehousePositionWare", map);
	...
	public Integer getWarehousePositionWareCount(String warehousePositionId) throws Exception {
		if (StringUtils.isBlank(warehousePositionId)) {
			throw new Exception("warehousePositionId is null ");
		}
		Map<String, String> param = new HashMap();
		...
		Integer count = Integer
				.valueOf(this.publicDAO.select("WarehousePositionWare.WarehousePositionWare", param).size());
		return count;
	}
}
