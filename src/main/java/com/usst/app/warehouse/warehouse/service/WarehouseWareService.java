...
public class WarehouseWareService extends BaseService<WarehouseWare> {
	public WarehouseWare getWarehouseWareByWareId(String wareId, String warehouseId) throws Exception {
	...
	public void updateInventory(Map<String, String> param, int changeNum, Double warePrice) throws Exception {
	...
	public void updateCost(String warehouseId, String wareId, Double changeCost) throws Exception {
		if (StringUtils.isBlank(wareId)) {
			throw new Exception("wareId is null");
		}
		if (StringUtils.isBlank(warehouseId)) {
	...
	public Integer getWareCount(String warehouseId) throws Exception {
		if (StringUtils.isBlank(warehouseId)) {
			throw new Exception("warehouseId is null");
		}
		Map<String, String> param = new HashMap();
