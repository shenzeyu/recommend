package com.usst.app.formcenter.orderform.salesummary;
		...
		try {
			...
			for (int j = 0; j < resultList.size(); j++) {
				...
				if ((this.saleWare.getSalesmoney() != null) && (this.saleWare.getGrossSales() != null)) {
					this.saleWare.setGrossMargin(Double.valueOf(this.saleWare.getGrossSales().doubleValue()
							/ this.saleWare.getSalesmoney().doubleValue() * 100.0D));
				}
				if ((this.saleWare.getTaxRate() != null) && (this.saleWare.getGoodPrice() != null)
						&& (this.saleWare.getOrderNumber() != null)) {
					this.saleWare.setTaxDueSum(Double.valueOf(
							this.saleWare.getTaxRate().doubleValue() * this.saleWare.getGoodPrice().doubleValue()
									* this.saleWare.getOrderNumber().doubleValue()));
				}
