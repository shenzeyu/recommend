package com.usst.app.system.rolePower.service;
...
import com.usst.app.system.rolePower.model.SysRolePower;
...
public class SysRolePowerService extends BaseService<SysRolePower> {
	...
	public void insert(List<SysRolePower> entityList) throws Exception {
	...
	public void deleteByPowerId(String powerId) throws Exception {
	...
	public SysRolePower selectOne(SysRolePower entity) throws Exception {
