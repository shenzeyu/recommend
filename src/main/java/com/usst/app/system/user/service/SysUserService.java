package com.usst.app.system.user.service;
...
public class SysUserService extends BaseService<SysUser> {
	...
	public boolean isSystemUser(String code, String pwd) throws Exception {
		...
		List<SysUser> userList = this.publicDAO.select("SysUser.SysUser", objParam);
	...
	public List<SysUser> getsysuerList(String roleId) throws Exception {
		if (StringUtils.isBlank(roleId)) {
			throw new Exception("goodTypeId is null!");
		}
		Map<String, String> param = new HashMap();
		param.put("roleId", roleId);
		List<SysUser> list = this.publicDAO.select("SysUser.SysUser", param);
		return list;
	}

	public SysUser insert(SysUser model) throws Exception {
		super.insert(model);
		return model;
	}

	public SysUser update(SysUser model) throws Exception {
		if (model == null) {
	...
	public void updatePassword(String id, String pwd) throws Exception {
