package com.usst.app.order.sale.saleDelivery.service;
...
public class SaleDeliveryService extends BaseService<SaleDelivery> {
	...
	public SaleDelivery getSaleDeliveryByOrderId(String orderId) throws Exception {
	...
	public void updateDeliveryInfo(String id, Double changeMoney) throws Exception {
	...
	public void updateDelivery(String id, Double changeMoney) throws Exception {
		if (StringUtils.isBlank(id)) {
			throw new Exception("id is null");
		}
		SaleDelivery saleDelivery = (SaleDelivery) getModel(id);
	...
	public List<SaleDelivery> getCustomerWlz(SaleDelivery saleDelivery) {
		List<SaleDelivery> list = this.publicDAO.select("SaleDelivery.SaleDelivery_CustomerLwz", saleDelivery);
		return list;
	}

	public List<SaleDelivery> getSaleDeliveryDSAndPSSum(SaleDelivery saleDelivery) {
		List<SaleDelivery> list = this.publicDAO.select("SaleDelivery.SaleDelivery", saleDelivery);
		return list;
	}
}
