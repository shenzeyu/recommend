package com.usst.app.store.promotecolumn.action;
...
import com.usst.app.store.promotecolumn.model.Promotecolumn;
import com.usst.app.store.promotecolumn.service.PromotecolumnService;
...
public class PromotecolumnAction extends BaseAction {
	...
	public String listJosn() {
		...
		List<Promotecolumn> resultList = null;
		int totalRows = 0;
		try {
